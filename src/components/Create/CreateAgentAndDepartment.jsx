    ...
    >
      <div className="w-full bg-[#1C1C2E] rounded-2xl pt-8 px-6 md:px-12 md:pb-[150px] flex flex-col items-center">
        <div className="max-w-[585px] w-full flex items-center gap-2 mb-32">
          {/* Department tab  */}
          <div
            className={`flex items-center gap-5 py-5 px-2 md:px-8 border-b-[3px] cursor-pointer ${
              QAType === "department"
                ? "border-[#3637EA]"
                : "border-transparent"
            }`}
          ...
          {/* Agent tab  */}
          <div
            className={`flex items-center gap-5 py-5 px-8 border-b-[3px] cursor-pointer ${
...
export default CreateAgentAndDepartment;

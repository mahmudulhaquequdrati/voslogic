...
export default function Agents() {
  ...
  const [isAgentCreate, setIsAgentCreate] = useState(false);
  ...
  return (
    <div className="">
      ...
      {isAgentCreate ? (
        <CreateAgentAndDepartment make="agent" />
      ) : (
        <div
